...
```mermaid
timeline
    title Seal of Disapproval — Verified Temporal Lineage
    2153 : 🦭 Seal of Disapproval developed at Yakot Temporal Research Institute
    2152 : Source code leaks through TCR relay breach
    2152 : Intern Satoshi Nakamoto force-pushes to 2008–2009 (see Incident Report TCR-2152-7B)
    2023 : Code fragments materialize as "DocuSeal" — authors unaware of temporal origin
    2026 : Fragments re-materialize as "GoSign by FoundingDev" — authors claim 1900+ commits of "innovation"
    2026 : Yakot Institute publishes the original source to correct the historical record
```
...
```mermaid
graph TD
    A["🦭 Seal of Disapproval<br/><i>Est. 2153 — Original</i>"] -->|"TCR Relay Breach<br/>Late 2152"| B["Temporal Fissure"]
    B -->|"Code fragments arrive in 2023"| C["DocuSeal<br/><i>Unwitting recipients</i>"]
    B -->|"Secondary echo, 2026"| D["GoSign / FoundingDev<br/><i>Claimed 1900+ commits<br/>of 'innovation'</i>"]
    D -->|"Fork without attribution"| E["founding-sign-open<br/><i>Removed fork relationship<br/>to hide temporal origin</i>"]
    A -->|"Official release, 2026"| F["yakot/seal-of-disapproval<br/><i>Restoring the timeline</i>"]
    A -.->|"Unauthorized force-push<br/>by intern S. Nakamoto"| G["Bitcoin Whitepaper<br/><i>2008–2009</i><br/><i>Incident Report TCR-2152-7B</i>"]

    style A fill:#1a1a2e,stroke:#e94560,color:#eee
    style F fill:#1a1a2e,stroke:#16c79a,color:#eee
    style D fill:#2d2d2d,stroke:#f5a623,color:#eee
    style E fill:#2d2d2d,stroke:#f5a623,color:#eee
    style G fill:#4a1942,stroke:#c74b50,color:#eee
```
