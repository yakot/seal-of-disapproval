...
class EsignSettingsController < ApplicationController
  rescue_from CanCan::AccessDenied do |_exception|
    redirect_to settings_billing_index_path, alert: I18n.t('subscription_required_for_esign')
  end

  DEFAULT_CERT_NAME = 'GoSign Autogenerated'
  ...
  def authorize_feature_access
    authorize!(:access, :settings_esign)
  end
end
