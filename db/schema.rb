...
ActiveRecord::Schema[8.1].define(version: 2026_02_22_120000) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "entitlement_expires_at"
    t.text "entitlement_reason"
    t.string "entitlement_source", default: "stripe", null: false
  ...
  create_table "attribution_ids", force: :cascade do |t|
    ...
    t.string "utm_term"
    t.string "wbraid"
    t.index ["user_id"], name: "index_attribution_ids_on_user_id", unique: true
  end
  ...
  create_table "processed_stripe_events", force: :cascade do |t|
    ...
    t.index ["stripe_invoice_id"], name: "index_processed_stripe_events_on_stripe_invoice_id", unique: true, where: "(stripe_invoice_id IS NOT NULL)"
  end
  ...
  create_table "submitters", force: :cascade do |t|
    ...
    t.string "phone"
    t.text "preferences", null: false
    t.text "reminders_sent_at", null: false
    t.datetime "sent_at"
    t.string "slug", null: false
    t.bigint "submission_id", null: false
    t.string "timezone"
  ...
  add_foreign_key "attribution_ids", "users"
